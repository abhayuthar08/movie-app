  ...
  return (
   <div>
     <div className='bg-zinc-800 w-full h-full flex'>
       ...
       <div className=''>
       <h2 className='relative text-5xl text-zinc-200 mt-[15vh] mx-[20vh]'>I am a Software Engineer</h2>
       ...
       <div className='bg-zinc-500'>  <img className=' rounded absolute h-[70vh] w-[70vh] mt-[20vh] ml-[15vh] ' src={abhi2} alt="" /></div>
