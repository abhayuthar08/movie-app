      ...
      <div className='flex'>
        ...
        <div className='ml-[5%] '>
          <h1 className='text-5xl text-white font-black'>   {info.detail.name || info.detail.title || info.detail.original_name || info.detail.original_title}
            ...
            <small className='text-xl text-zinc-300 font-bold'>({info.detail.first_air_date.split("-")[0]})</small> </h1>
          ...
          <div className='text-white gap-x-10 mr-[50%] flex items-center justify-center mt-3 mb-5'>
            ...
            <h1 className=''>{info.detail.first_air__date}</h1>
            <h1>
          ...
          <h1 className='text-zinc-100  text-xl mt-5 mb-3'>tv Translated</h1>
